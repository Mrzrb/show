...
!function(t, e) {
    ...
    var C, L, P, M, j = I.inspectSource, N = r.WeakMap, q = "function" == typeof N && /native code/.test(j(N)), U = e((function(t) {
    ...
    )), D = 0, Z = Math.random(), W = function(t) {
        return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++D + Z).toString(36)
    }, K = U("keys"), J = {}, F = r.WeakMap;
    if (q) {
        var H = new F
          , B = H.get
          , Y = H.has
    ...
    var X = {
      ...
      , Q = e((function(t) {
        ...
        (t.exports = function(t, e, a, o) {
            var l = !!o && !!o.unsafe
              , s = !!o && !!o.enumerable
              , c = !!o && !!o.noTargetGet;
            "function" == typeof a && ("string" != typeof e || k(a, "name") || z(a, "name", e),
            n(a).source = i.join("string" == typeof e ? e : "")),
            t !== r ? (l ? !c && t[e] && (s = !0) : delete t[e],
            s ? t[e] = a : z(t, e, a)) : s ? t[e] = a : R(e, a)
        }
      ...
      , pt = function(t) {
        return function(e, n, r) {
            var i, a = g(e), o = lt(a.length), l = ut(r, o);
            if (t && n != n) {
                for (; o > l; )
                    if ((i = a[l++]) != i)
                        return !0
      ...
      , ft = dt.indexOf
      , ht = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"].concat("length", "prototype")
      , gt = {
        f: Object.getOwnPropertyNames || function(t) {
            return function(t, e) {
                var n, r = g(t), i = 0, a = [];
                for (n in r)
                    !k(J, n) && k(r, n) && a.push(n);
                for (; e.length > i; )
      ...
      , _t = T.f
      , At = function(t, e) {
        var n, i, a, o, l, s = t.target, c = t.global, u = t.stat;
    ...
    var Ot = {
      ...
      , Mt = void 0 !== /()??/.exec("")[1];
    (Lt || Mt || Pt) && (Ct = function(t) {
        var e, n, r, i, a = this, o = Pt && a.sticky, l = zt.call(a), s = a.source, c = 0, u = t;
        ...
        r[0] = r[0].slice(c),
        r.index = a.lastIndex,
        a.lastIndex += r[0].length) : a.lastIndex = 0 : Lt && r && (a.lastIndex = a.global ? r.index + r[0].length : e),
        Mt && r && r.length > 1 && $t.call(r[0], n, (function() {
    ...
    var Nt = !!Object.getOwnPropertySymbols && !i((function() {
      ...
      , Wt = function(t) {
        return k(Ut, t) || (Nt && k(Dt, t) ? Ut[t] = Dt[t] : Ut[t] = Zt("Symbol." + t)),
        Ut[t]
    }
      , Kt = Wt("species")
      , Jt = !i((function() {
      ...
      , Vt = function(t, e, n, r) {
        ...
        if (!o || !l || "replace" === t && (!Jt || !Ft || Bt) || "split" === t && !Yt) {
            var s = /./[a]
              , c = n(a, ""[t], (function(t, e, n, r, i) {
                return e.exec === jt ? o && !i ? {
                    done: !0,
                    value: s.call(e, n, r)
                } : {
                    done: !0,
            ...
            Q(RegExp.prototype, a, 2 == e ? function(t, e) {
      ...
      , Gt = function(t) {
        return function(e, n) {
            var r, i, a = String(h(e)), o = at(n), l = a.length;
            return o < 0 || o >= l ? t ? "" : void 0 : (r = a.charCodeAt(o)) < 55296 || r > 56319 || o + 1 === l || (i = a.charCodeAt(o + 1)) < 56320 || i > 57343 ? t ? a.charAt(o) : r : t ? a.slice(o, o + 2) : i - 56320 + (r - 55296 << 10) + 65536
        }
    }
      , Xt = {
        codeAt: Gt(!1),
    ...
    Vt("search", 1, (function(t, e, n) {
        ...
        , function(t) {
            ...
            var l = te(i, a);
            return ee(i.lastIndex, o) || (i.lastIndex = o),
            null === l ? -1 : l.index
        }
        ]
    }
    ...
    var re = "[object z]" === String(ne)
      ...
      , oe = re ? p : function(t) {
        ...
        }(e = Object(t), ie)) ? n : ae ? p(e) : "Object" == (r = p(e)) && "function" == typeof e.callee ? "Arguments" : r
    }
      , le = re ? {}.toString : function() {
        return "[object " + oe(this) + "]"
    }
    ;
    re || Q(Object.prototype, "toString", le, {
        unsafe: !0
    });
    var se = "toString"
      , ce = RegExp.prototype
    ...
    (pe || de) && Q(RegExp.prototype, se, (function() {
        var t = E(this)
          , e = String(t.source)
          , n = t.flags;
    ...
    , Je = Wt("species"), Fe = function(t, e) {
        var n;
        return Ke(t) && ("function" != typeof (n = t.constructor) || n !== Array && !Ke(n.prototype) ? m(n) && null === (n = n[Je]) && (n = void 0) : n = void 0),
        new (void 0 === n ? Array : n)(0 === e ? 0 : e)
    }, He = [].push, Be = function(t) {
        var e = 1 == t
          , n = 2 == t
          , r = 3 == t
          , i = 4 == t
        ...
        return function(l, s, c, u) {
            for (var p, d, h = be(l), g = f(h), m = function(t, e, n) {
                if (We(t),
                void 0 === e)
                    return t;
                switch (n) {
            ...
            }(s, c, 3), v = lt(g.length), y = 0, k = u || Fe, b = e ? k(l, v) : n ? k(l, 0) : void 0; v > y; y++)
                if ((o || y in g) && (d = m(p = g[y], y, h),
                t))
                    if (e)
                        b[y] = d;
                    else if (d)
        ...
        find: Be(5),
        findIndex: Be(6)
    }, Ve = nt("navigator", "userAgent") || "", Ge = r.process, Xe = Ge && Ge.versions, Qe = Xe && Xe.v8;
    Qe ? Ze = (De = Qe.split("."))[0] + De[1] : Ve && (!(De = Ve.match(/Edge\/(\d+)/)) || De[1] >= 74) && (De = Ve.match(/Chrome\/(\d+)/)) && (Ze = De[1]);
    var tn = Ze && +Ze
      , en = Wt("species")
      , nn = function(t) {
        return tn >= 51 || !i((function() {
            var e = [];
    ...
    At({
        ...
        slice: function(t, e) {
            var n, r, i, a = g(this), o = lt(a.length), l = ut(t, o), s = ut(void 0 === e ? o : e, o);
            if (Ke(a) && ("function" != typeof (n = a.constructor) || n !== Array && !Ke(n.prototype) ? m(n) && null === (n = n[un]) && (n = void 0) : n = void 0,
            n === Array || void 0 === n))
    ...
    var fn = Object.setPrototypeOf || ("__proto__"in {} ? function() {
        var t, e = !1, n = {};
        try {
      ...
      , En = new wn(Sn) !== Sn
      , _n = Ot.UNSUPPORTED_Y;
    if (a && Et("RegExp", !En || _n || i((function() {
        return Tn[bn] = !1,
        wn(Sn) != Sn || wn(Tn) == Tn || "/a/i" != wn(Sn, "i")
    }
    )))) {
        for (var An = function(t, e) {
            var n, r = this instanceof An, i = gn(t), a = void 0 === e;
            if (!r && i && t.constructor === An && a)
                return t;
            En ? i && !a && (t = t.source) : t instanceof An && (a && (e = zt.call(t)),
            t = t.source),
            _n && (n = !!e && e.indexOf("y") > -1) && (e = e.replace(/y/g, ""));
            var o, l, s, c, u, p = (o = En ? new wn(t,e) : wn(t, e),
            l = r ? this : xn,
            s = An,
            fn && "function" == typeof (c = l.constructor) && c !== s && m(u = c.prototype) && u !== s.prototype && fn(o, u),
            o);
            return _n && n && kn(p, {
                sticky: n
            }),
    ...
    var In, $n = function(t) {
        ...
        return !1
    }, Pn = T.f, Mn = "".endsWith, jn = Math.min, Nn = Ln("endsWith");
    At({
        target: "String",
        proto: !0,
        forced: !!(Nn || (In = Pn(String.prototype, "endsWith"),
        !In || In.writable)) && !Nn
    }, {
        endsWith: function(t) {
            var e = String(h(this));
    ...
    Vt("split", 2, (function(t, e, n) {
        ...
        return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, n) {
            ...
            if (!gn(t))
                return e.call(r, t, i);
            for (var a, o, l, s = [], c = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), u = 0, p = new RegExp(t.source,c + "g"); (a = jt.call(p, r)) && !((o = p.lastIndex) > u && (s.push(r.slice(u, a.index)),
            a.length > 1 && a.index < r.length && Un.apply(s, a.slice(1)),
            l = a[0].length,
            u = o,
            s.length >= i)); )
                p.lastIndex === a.index && p.lastIndex++;
            return u === r.length ? !l && p.test("") || s.push("") : s.push(r.slice(u)),
        ...
        , function(t, i) {
            ...
            if (0 === d)
                return [];
            if (0 === l.length)
                return null === te(p, l) ? [l] : [];
            for (var f = 0, h = 0, g = []; h < l.length; ) {
                p.lastIndex = Wn ? h : 0;
                var m, v = te(p, Wn ? l : l.slice(h));
                if (null === v || (m = Dn(lt(p.lastIndex + (Wn ? 0 : h)), l.length)) === f)
                    h = Qt(l, h, c);
                else {
    ...
    At({
        ...
        splice: function(t, e) {
            var n, r, i, a, o, l, s = be(this), c = lt(s.length), u = ut(t, c), p = arguments.length;
    ...
    function Ar(t, e) {
        ...
        return "//" === e.substring(0, 2) ? n ? e : t.replace(Er, "$1") + e : "/" === e.charAt(0) ? n ? e : t.replace(_r, "$1") + e : t + e
    }
    function zr(t, e, n) {
        var r = t.length;
        if (0 === r)
      ...
      , Ir = function(t, e) {
        ...
        var n = {
            replace: function(e, r) {
                return r = (r = r.source || r).replace(br, "$1"),
                t = t.replace(e, r),
                n
            },
            getRegex: function() {
    ...
    var Jr = function() {
        ...
        return ge(t, [{
            ...
            value: function(t) {
                ...
                if (e) {
                    for (var n, r, i, a, o, l, s, c = e[0], u = e[2], p = u.length > 1, d = {
                        type: "list",
                        raw: c,
                        ordered: p,
                        start: p ? +u : "",
            ...
            value: function(t) {
                ...
                if (e)
                    return {
                        ...
                        text: this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(e[0]) : Zr(e[0]) : e[0]
                    }
            }
        }, {
            key: "def",
            ...
            value: function(t, e, n) {
                ...
                if (r)
                    ...
                    !n && /^<(pre|code|kbd|script)(\s|>)/i.test(r[0]) ? n = !0 : n && /^<\/(pre|code|kbd|script)(\s|>)/i.test(r[0]) && (n = !1),
                    {
                        ...
                        inLink: e,
                        inRawBlock: n,
                        text: this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(r[0]) : Zr(r[0]) : r[0]
                    }
            }
        }, {
            key: "link",
            ...
            value: function(t, e) {
                ...
                if (i)
                    return r = "@" === i[2] ? "mailto:" + (n = Zr(this.options.mangle ? e(i[1]) : i[1])) : n = Zr(i[1]),
                    {
                        type: "link",
                        raw: i[0],
                        text: n,
            ...
            value: function(t, e, n) {
                ...
                if (i)
                    return r = e ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(i[0]) : Zr(i[0]) : i[0] : Zr(this.options.smartypants ? n(i[0]) : i[0]),
                    {
                        type: "text",
                        raw: i[0],
                        text: r
    ...
    Yr.list = Hr(Yr.list).replace(/bull/g, Yr.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + Yr.def.source + ")").getRegex(),
    Yr._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
    Yr._comment = /<!--(?!-?>)[\s\S]*?-->/,
    Yr.html = Hr(Yr.html, "i").replace("comment", Yr._comment).replace("tag", Yr._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
    Yr.paragraph = Hr(Yr._paragraph).replace("hr", Yr.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", Yr._tag).getRegex(),
    ...
    Yr.gfm.table = Hr(Yr.gfm.table).replace("hr", Yr.hr).replace("heading", " {0,3}#{1,6} ").replace("blockquote", " {0,3}>").replace("code", " {4}[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", Yr._tag).getRegex(),
    Yr.pedantic = Br({}, Yr.normal, {
        html: Hr("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment", Yr._comment).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),
        def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,
        heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
        fences: Fr,
        paragraph: Hr(Yr.normal._paragraph).replace("hr", Yr.hr).replace("heading", " *#{1,6} *[^\n]").replace("lheading", Yr.lheading).replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "").getRegex()
    });
    var Vr = {
        escape: /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,
    ...
    Vr.em = Hr(Vr.em).replace(/punctuation/g, Vr._punctuation).getRegex(),
    Vr._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,
    ...
    Vr._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
    Vr.link = Hr(Vr.link).replace("label", Vr._label).replace("href", Vr._href).replace("title", Vr._title).getRegex(),
    Vr.reflink = Hr(Vr.reflink).replace("label", Vr._label).getRegex(),
    Vr.normal = Br({}, Vr),
    Vr.pedantic = Br({}, Vr.normal, {
        strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,
        em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/,
        link: Hr(/^!?\[(label)\]\((.*?)\)/).replace("label", Vr._label).getRegex(),
        reflink: Hr(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", Vr._label).getRegex()
    }),
    Vr.gfm = Br({}, Vr.normal, {
    ...
    Vr.breaks = Br({}, Vr.gfm, {
        ...
        text: Hr(Vr.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
    });
    var Gr = {
        block: Yr,
        inline: Vr
    ...
    var ri = function() {
        function t(e) {
            ...
            this.options.pedantic ? (n.block = Qr.pedantic,
            n.inline = ti.pedantic) : this.options.gfm && (n.block = Qr.gfm,
        ...
        return ge(t, [{
            ...
            key: "blockTokens",
            value: function(t) {
                var e, n, r, i, a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], o = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
            ...
            key: "inlineTokens",
            value: function(t) {
                for (var e, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = arguments.length > 3 && void 0 !== arguments[3] && arguments[3]; t; )
      ...
      , li = function() {
        ...
        return ge(t, [{
            ...
            value: function(t, e, n) {
                ...
                return r ? '<pre><code class="' + this.options.langPrefix + oi(r, !0) + '">' + (n ? t : oi(t, !0)) + "</code></pre>\n" : "<pre><code>" + (n ? t : oi(t, !0)) + "</code></pre>\n"
            }
        }, {
            key: "blockquote",
            value: function(t) {
            ...
            key: "link",
            value: function(t, e, n) {
                if (null === (t = ai(this.options.sanitize, this.options.baseUrl, t)))
                    return n;
                var r = '<a href="' + oi(t) + '"';
                return e && (r += ' title="' + e + '"'),
                r += ">" + n + "</a>"
      ...
      , di = function() {
        ...
        return ge(t, [{
            key: "parse",
            value: function(t) {
                var e, n, r, i, a, o, l, s, c, u, p, d, f, h, g, m, v, y, k = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], b = "", w = t.length;
                for (e = 0; e < w; e++)
                    switch ((u = t[e]).type) {
                    case "space":
                        continue;
                    case "hr":
                        ...
                        continue;
                    case "heading":
                        b += this.renderer.heading(this.parseInline(u.tokens), u.depth, pi(this.parseInline(u.tokens, this.textRenderer)), this.slugger);
                        continue;
                    case "code":
                    ...
                    case "table":
                        ...
                        for (s += this.renderer.tablerow(l),
                        c = "",
                        i = u.cells.length,
                        n = 0; n < i; n++) {
                            for (l = "",
                            a = (o = u.tokens.cells[n]).length,
                            r = 0; r < a; r++)
                    ...
                    case "list":
                        ...
                        n = 0; n < i; n++)
                            ...
                            v = g.task,
                            h = "",
                            g.task && (y = this.renderer.checkbox(m),
                            f ? g.tokens.length > 0 && "text" === g.tokens[0].type ? (g.tokens[0].text = y + " " + g.tokens[0].text,
                            g.tokens[0].tokens && g.tokens[0].tokens.length > 0 && "text" === g.tokens[0].tokens[0].type && (g.tokens[0].tokens[0].text = y + " " + g.tokens[0].tokens[0].text)) : g.tokens.unshift({
                                type: "text",
                                text: y
                            }) : h += y),
    ...
    function ki(t, e, n) {
        ...
        n) {
            ...
            !r.length)
                return a();
            var o = 0;
            return ki.walkTokens(r, (function(t) {
                "code" === t.type && (o++,
        ...
        try {
            var l = ri.lex(t, e);
            return e.walkTokens && ki.walkTokens(l, e.walkTokens),
            di.parse(l, e)
        } catch (t) {
            ...
            var n = ki.defaults.renderer || new li
              , r = function(e) {
                ...
                n[e] = function() {
                    ...
                    return !1 === l && (l = r.apply(n, a)),
                    l
                }
            };
            for (var i in t.renderer)
                r(i);
            e.renderer = n
        }(),
    ...
    return function() {
        ...
        function n() {
            ...
            window.addEventListener("message", (function(i) {
                var a, o, l, s, c = JSON.parse(i.data);
                c && "reveal-notes" === c.namespace && "connected" === c.type && (clearInterval(n),
                t.on("slidechanged", r),
                ...
                t.on("resumed", r),
                r()),
                c && "reveal-notes" === c.namespace && "call" === c.type && (a = c.methodName,
                o = c.arguments,
                l = c.callId,
                s = t[a].apply(t, o),
                e.postMessage(JSON.stringify({
            ...
            function r(n) {
                ...
                if (r.hasAttribute("data-notes") && (o.notes = r.getAttribute("data-notes"),
                o.whitespace = "pre-wrap"),
                a) {
                    var l = a.querySelector("aside.notes");
                    l ? i = l : a.hasAttribute("data-notes") && (o.notes = a.getAttribute("data-notes"),
                    o.whitespace = "pre-wrap",
                    i = null)
                }
                i && (o.notes = i.innerHTML,
